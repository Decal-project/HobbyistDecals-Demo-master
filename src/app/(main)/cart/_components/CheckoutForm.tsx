...
                                }}
                                createOrder={async (_data: PayPalCreateOrderData, _actions: PayPalActions) => { // Handled unused 'data' and 'actions'
                                    try {
...
                                    }
                                }}
                                onApprove={async (data: PayPalOnApproveData, _actions: PayPalActions) => { // Handled unused 'actions'
                                    try {
